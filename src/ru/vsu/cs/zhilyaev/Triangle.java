...
public class Triangle {
    ...
    /*
       ...
       if((l1 == 0 && l2 > 0 && l2 < 1 && l3 > 0 && l3 < 1) || (l1 == 1 && l2 > 0 && l2 < 1 && l3 > 0 && l3 < 1)
               || (l2 == 0 && l1 > 0 && l1 < 1 && l3 > 0 && l3 < 1) || (l2 == 1 && l1 > 0 && l1 < 1 && l3 > 0 && l3 < 1) ||
                (l3 == 0 && l2 > 0 && l2 < 1 && l1 > 0 && l1 < 1) || (l3 == 1 && l2 > 0 && l2 < 1 && l1 > 0 && l1 < 1)) {
            pixelValue = Color.BLACK.getRGB(); // Обводка треугольниика
     */
}
